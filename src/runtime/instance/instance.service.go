...
func CreateService(
	...
	nodeMonitor := CreateNodeMonitor(socketManager, deploymentProvider)
...
func (s *instanceService) DeployLabCommand(ctx context.Context, labId string, authUser *auth.AuthenticatedUser) error {
...
func (s *instanceService) DestroyLabCommand(ctx context.Context, labId string, authUser *auth.AuthenticatedUser) error {
	instanceLab, err := s.validateLabCommand(ctx, labId, authUser)
	if err != nil {
		return err
	}
...
func (s *instanceService) StartNodeCommand(
	ctx context.Context,
	labId string,
	nodeId *string,
	authUser *auth.AuthenticatedUser,
...
func (s *instanceService) StopNodeCommand(
	ctx context.Context,
	labId string,
	nodeName *string,
	authUser *auth.AuthenticatedUser,
...
func (s *instanceService) RestartNodeCommand(
	ctx context.Context,
	labId string,
	nodeId *string,
	authUser *auth.AuthenticatedUser,
...
func (s *instanceService) validateLabCommand(
	ctx context.Context,
	labId string,
	authUser *auth.AuthenticatedUser,
) (*lab.Lab, error) {
...
func (s *instanceService) validateNodeCommand(
	ctx context.Context,
	labId string,
	nodeName *string,
	authUser *auth.AuthenticatedUser,
...
func (s *instanceService) runShellManager() {
	for {
...
func (s *instanceService) registerProviderEventListener() {
...
func (s *instanceService) GetInstance(labId string) *Instance {
	s.instancesMutex.Lock()
...
func (s *instanceService) DestroyLab(lab *lab.Lab) error {
	s.instancesMutex.Lock()
...
func (s *instanceService) redeployLab(lab *lab.Lab, instance *Instance) error {
	instance.Mutex.Lock()
	defer instance.Mutex.Unlock()
...
func (s *instanceService) openSshSession(host string, nodeKind string) (io.ReadWriteCloser, error) {
...
func (s *instanceService) DeployLab(lab *lab.Lab) error {
...
func (s *instanceService) startNodeStartupListener(node *InstanceNode, instance *Instance, lab *lab.Lab) {
	ctx := context.Background()
...
func (s *instanceService) onNodeStarted(ctx context.Context, instance *Instance, node *InstanceNode, lab *lab.Lab) {
...
func (s *instanceService) extractNodeLabels(topologyDefinition any) map[string]map[string]string {
...
func (s *instanceService) extractNodeKinds(topologyDefinition any) map[string]string {
...
func (s *instanceService) updateInstanceNode(
	ctx context.Context,
	instance *Instance,
	instanceName string,
	node *InstanceNode,
...
func (s *instanceService) getNodesFromInspect(
	ctx context.Context,
	instance *Instance,
	instanceName string,
	onLog func(data string),
...
func (s *instanceService) containerToInstanceNode(
...
func (s *instanceService) notifyUpdate(lab lab.Lab, message *statusMessage.StatusMessage) {
	s.updatesNamespace.Send(InstanceUpdate{
		LabId: &lab.UUID,
	})
...
func (s *instanceService) updateStateAndNotify(
	lab *lab.Lab,
	instance *Instance,
	state InstanceState,
...
func (s *instanceService) FetchShellsCommand(
	ctx context.Context,
	labId string,
	authUser *auth.AuthenticatedUser,
) ([]ShellData, error) {
...
func (s *instanceService) OpenShellCommand(
	ctx context.Context,
	labId string,
	nodeName *string,
	authUser *auth.AuthenticatedUser,
...
func (s *instanceService) CloseShellCommand(shellId *string, authUser *auth.AuthenticatedUser) error {
	if shellId == nil {
		return utils.ErrInvalidSocketRequest
	}
...
func (s *instanceService) openNodeShell(ctx context.Context, node InstanceNode) (io.ReadWriteCloser, error) {
	var host string
...
func (s *instanceService) closeNodeShells(nodeName string) {
...
func (s *instanceService) closeShell(shellId string, shell *ShellConfig, reason string) error {
	s.shellCommandsNamespace.Send(ShellCommandData{
		LabId:   shell.LabId,
		Node:    shell.Node,
		ShellId: shellId,
...
func (s *instanceService) handleShellData(
	shellId string,
) func(
	ctx context.Context,
	data *string,
...
func (s *instanceService) IsRunning(labId string) bool {
	s.instancesMutex.Lock()
	defer s.instancesMutex.Unlock()
...
func (s *instanceService) CanDelete(labId string) bool {
	s.instancesMutex.Lock()
	defer s.instancesMutex.Unlock()
